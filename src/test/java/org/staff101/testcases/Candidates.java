...
public class Candidates extends Baseclass {
	...
	By byCM = By.xpath("//a[contains(text(),'CANDIDATES')]");
	By byBTT = By.xpath("//div[6]/div[1]/div[1]/a[1]/div[2]/i[1]");

	@Test(groups = {"AllTest","Candidates"})
	public void Candidates_Page()
	{
		Reporter.log("Clicking on Candidates Module", true);
		
		wait = new WebDriverWait(driver,Duration.ofSeconds(80));
		
		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(byCM));
		driver.findElement(byCM).click();
