...
public class Sign_In2 extends Baseclass{

	By bySI = By.xpath("//nav[@id='staffheader']/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/ul[1]/li[2]");
	By byET = By.xpath("//div[@id='signin']/div[1]/div[1]/div[2]/div[1]/div[2]/a[2]");
	...
	@Test(groups = {"AllTest","Sign_In2"})
	public void Sign_In_Employer ()
	{
